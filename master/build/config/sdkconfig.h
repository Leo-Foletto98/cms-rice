...
#define CONFIG_MEM_ALLOCATION_DEFAULT 1
#define CONFIG_MEM_DEBUG 1
#define CONFIG_MEM_DBG_INFO_MAX 128
#define CONFIG_NVS_NAMESPACE "espnow"
#define CONFIG_REBOOT_UNBROKEN_INTERVAL_TIMEOUT 5000
#define CONFIG_REBOOT_UNBROKEN_FALLBACK_COUNT 30
